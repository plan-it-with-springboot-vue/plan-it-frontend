      ...
      <div id="board-detail-comment-content-box">
        ...
        >
          <div id="board-detail-comment-header-box">
            ...
            <div>
              <svg
                id="board-detail-comment-header-setting"
